...
class AppColors {
  static const primaryColor = Color(0xff61E002);
  static const secondColor = Color(0xff58CC02);
  static const background = Color(0xffFFFFFF);
  static const secondBackground = Color(0xffF7F7F7);

  static const textFirstColor = Color(0xffFFFFFF);
